...
commodities. Kalman filter, HMM, Supply Shock Index, Bayesian 
surprise, cointegration. FastAPI + Docker. → [View](./CommodityKing/)

## Research Notebooks
Four quantitative finance notebooks covering LSTM stock prediction, 
NN vs RNN vs LSTM comparison, options pricing via Monte Carlo, 
and pairs trading vs cross-sectional momentum.
